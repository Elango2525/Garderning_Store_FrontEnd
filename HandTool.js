...
const HandTool = ({ handleAddToCart }) => {
  ...
  const handToolsProducts = [
    {
      "id": 1,
      "productname": "Bent Scraper",
      "quantity": 1,
      "price": 249,
      "discountedPrice": 199,
      "shippingCost": 19,
      "offer": "20% OFFER",
      "imageUrl": "https://www.ugaoo.com/cdn/shop/products/1-inch-bent-scraper-32010412490884.jpg?v=1675564029",
      "reviews": [
        {
    ...
    {
      "id": 2,
      "productname": "Cultivator with Handle",
      "quantity": 1,
      "price": 385,
      "discountedPrice": 225,
      "shippingCost": "Free delivery",
      "imageUrl": "https://www.ugaoo.com/cdn/shop/products/cultivator-with-wooden-handle-31881300213892.jpg?v=1675580406",
      "reviews": [
        {
          "customerName": "John Doe",
          "rating": 3,
    ...
    {
      "id": 3,
      "productname": "The Watermatic Stake-XL",
      "quantity": 1,
      "price": 799,
      "discountedPrice": 349,
      "shippingCost": "Free delivery",
      "offer": "57% OFFER",
      "imageUrl": "https://www.ugaoo.com/cdn/shop/products/handy-clipper-32010557227140.jpg?v=1675563669",
      "reviews": [
        {
          "customerName": "John Doe",
          "rating": 3,
    ...
    {
      "id": 4,
      "productname": "Double Prong Weeder",
      "quantity": 1,
      "price": 255,
      "discountedPrice": 199,
      "shippingCost": "Free delivery",
      "imageUrl": "https://www.ugaoo.com/cdn/shop/products/double-prong-weeder-31881688514692.jpg?v=1675578420",
      "reviews": [
        {
          "customerName": "John Doe",
          "rating": 3,
...
>
  ...
  {product.reviews && (
    <Link to={`/reviews/${product.id}`} onClick={handleReviewsClick}className="review-link" onClick={() => handleReviewsClick(product.id)}>
  ...
  <div className="footer-links">
    ...
    <div className='about'>
    <a>About</a></div></div><div className='about-det'><Link to="/getRev">History</Link></div><div className='about-det1'>Awards</div>
    <div className='rowCol'>
