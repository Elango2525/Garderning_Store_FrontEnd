...
const HandTool = ({ handleAddToCart }) => {
  ...
  const handToolsProducts = [
    {
      "id": 61,
      "productname": "Seaweed Extract Fertilizer",
      "quantity": 1,
      "price": 299,
      "discountedPrice": 159,
      "shippingCost": "Delivery @ 45",
      "offer": "49% OFFER",
      "imageUrl": "https://www.ugaoo.com/cdn/shop/products/Plant_Tonic_100.jpg?v=1668666969",
      "reviews": [
        {
    ...
    {
      "id": 62,
      "productname": "Plant Fertilizer Pellets",
      "quantity": 1,
      "price": 339,
      "discountedPrice": 236,
      "shippingCost": "Free delivery",
      "offer": "SBI OFFER",
      "imageUrl": "https://www.ugaoo.com/cdn/shop/products/plant-fertilizer-pellets-1-kg-31259756494980.png?v=1675600557",
      "reviews": [
        {
          "customerName": "John Doe",
          "rating": 3,
    ...
    {
      "id": 64,
      "productname": "Amruth Organic Fertilizer",
      "quantity": 1,
      "price": 635,
      "discountedPrice": 529,
      "offer": "SBI OFFER",
      "shippingCost": "Free delivery",
      "imageUrl": "https://n4.sdlcdn.com/imgs/j/f/6/Amruth-Organic-Fertilizers-Bio-fertilizer-SDL937915063-1-e0c83.jpg",
      "reviews": [
        {
          "customerName": "John Doe",
          "rating": 3,
      ...
      "shippingCost": "Free delivery",
      "offer": "23% OFFER",
      "imageUrl": "https://i5.walmartimages.com/asr/58d1949b-79f4-43f8-ac22-5eca34023084_1.6c396ee554923a492c4f0a7f06de3b4d.jpeg?odnWidth=1000&odnHeight=1000&odnBg=ffffff",
      "reviews": [
        {
          "customerName": "John Doe",
          "rating": 3,
            ...
            <div className="image-column" key={product.id}>
              <div className="image-reItem">
                ...
                <div children="buy-now-button">
                  <button className="add-to-cart-button" onClick={() => handleAddToCartClick(product)}>
                    ADD TO CART
                  </button>
                </div>
                <br />
